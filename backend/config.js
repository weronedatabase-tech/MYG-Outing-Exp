...
// The frontend will now call the local Node.js proxy to solve concurrency scaling
const API_URL = '/api';

// For Node.js Server to know which GAS backend to hit
const GAS_BACKEND_URL = ENV === 'Exp' ? EXP_URL : (ENV === 'Dev' ? DEV_URL : PROD_URL);
...
// Support both CommonJS (for Node) and Browser contexts
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { ENV, GAS_BACKEND_URL, Drive_Folder_ID };
}