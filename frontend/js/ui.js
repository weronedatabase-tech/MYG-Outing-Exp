...
function showPersonInfo(personObj) {
    ...
    } else if (window.location.pathname.includes('pairing.html')) {
    ...
    } else if (window.location.pathname.includes('grouping.html')) {
    ...
    apiCall('submitAttendanceData', payload).then(res => {
        if(res.success) {
            ...
            setTimeout(() => {
                ...
                if (window.location.pathname.includes('tracker.html') && typeof manualSyncCommAttendance === 'function') {
                    manualSyncCommAttendance();
                } else if (window.location.pathname.includes('pairing.html') && typeof manualSyncManualPairing === 'function') {
                    manualSyncManualPairing();
                } else if (window.location.pathname.includes('grouping.html') && typeof manualSyncGrouping === 'function') {
                    manualSyncGrouping();
                }
            }, 1500);
        } else {
